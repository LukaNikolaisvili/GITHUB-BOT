...
const REPO_URL = "https://github.com/LukaNikolaisvili/github_bot.git";
const REPO_DIR = "/var/jenkins_home/workspace/test/github_bot";
...
const makeCommit = async (n) => {
  ...
  if (!fs.existsSync(REPO_DIR)) {
    ...
    await execute(`git clone https://${process.env.GITHUB_TOKEN}@github.com/LukaNikolaisvili/github_bot.git ${REPO_DIR}`);
  } else {
